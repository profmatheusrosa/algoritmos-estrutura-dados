...
| 8. Recursão e Backtracking | 8.1 Fundamentos de Recursão | Chamadas recursivas, caso base, pilha de chamadas |
|  | 8.2 Backtracking | Técnica de tentativa e erro, poda de árvores de decisão |
|  | 8.3 Aplicações | Permutações, N-Rainhas, Sudoku |
| 9. Design de Sistemas | 9.1 Fundamentos e Pilares | Conceitos essenciais, escalabilidade, disponibilidade |
|  | 9.2 APIs e Comunicação | REST, GraphQL, gRPC, comunicação síncrona/assíncrona |
|  | 9.3 Bancos de Dados e Caches | SQL vs NoSQL, estratégias de cache, consistência de dados |
|  | 9.4 Arquitetura Avançada | DNS, Load Balancers, Padrões de Arquitetura |